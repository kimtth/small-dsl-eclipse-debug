...
/**
 * Abstract handler for processing interpreter state and debugging.
 * Manages thread suspension, resumption, and breakpoint handling.
 */
public abstract class AbstractProcessHandler extends ThreadLauncher {
