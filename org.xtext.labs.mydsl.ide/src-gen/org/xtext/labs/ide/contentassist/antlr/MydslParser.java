 ...
 */
package org.xtext.labs.ide.contentassist.antlr;
...
import org.xtext.labs.ide.contentassist.antlr.internal.InternalMydslParser;
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getBodyStatementAccess().getAlternatives(), "rule__BodyStatement__Alternatives");
					put(grammarAccess.getVarTypeLiteralAccess().getAlternatives(), "rule__VarTypeLiteral__Alternatives");
					put(grammarAccess.getVarDeclaredAccess().getScopeAlternatives_1_0(), "rule__VarDeclared__ScopeAlternatives_1_0");
					put(grammarAccess.getVarDeclaredAccess().getAlternatives_2(), "rule__VarDeclared__Alternatives_2");
					put(grammarAccess.getTerminalAccess().getAlternatives(), "rule__Terminal__Alternatives");
					put(grammarAccess.getTerminalAccess().getVarRefAlternatives_2_1_0(), "rule__Terminal__VarRefAlternatives_2_1_0");
					put(grammarAccess.getVarSymbolAccess().getAlternatives(), "rule__VarSymbol__Alternatives");
					put(grammarAccess.getTerminalOrMethodAccess().getAlternatives(), "rule__TerminalOrMethod__Alternatives");
					put(grammarAccess.getArrayDimensionAccess().getAlternatives_2(), "rule__ArrayDimension__Alternatives_2");
					put(grammarAccess.getAbstractMethodCallAccess().getAlternatives(), "rule__AbstractMethodCall__Alternatives");
					put(grammarAccess.getStdfunctionListAccess().getAlternatives(), "rule__StdfunctionList__Alternatives");
					put(grammarAccess.getOperAccess().getAlternatives(), "rule__Oper__Alternatives");
					...
					put(grammarAccess.getDSLProgramAccess().getGroup(), "rule__DSLProgram__Group__0");
					put(grammarAccess.getMainDeclaredAccess().getGroup(), "rule__MainDeclared__Group__0");
					put(grammarAccess.getVarReturnAccess().getGroup(), "rule__VarReturn__Group__0");
					put(grammarAccess.getVarDeclaredAccess().getGroup(), "rule__VarDeclared__Group__0");
					put(grammarAccess.getVarDeclaredAccess().getGroup_2_1(), "rule__VarDeclared__Group_2_1__0");
					put(grammarAccess.getVarAssignmentAccess().getGroup(), "rule__VarAssignment__Group__0");
					put(grammarAccess.getVarAssignmentAccess().getGroup_1(), "rule__VarAssignment__Group_1__0");
					put(grammarAccess.getVarAssignmentAccess().getGroup_1_1(), "rule__VarAssignment__Group_1_1__0");
					...
					put(grammarAccess.getTerminalAccess().getGroup_4(), "rule__Terminal__Group_4__0");
					put(grammarAccess.getArrayDimensionAccess().getGroup(), "rule__ArrayDimension__Group__0");
					put(grammarAccess.getFuncCallAccess().getGroup(), "rule__FuncCall__Group__0");
					put(grammarAccess.getFuncCallAccess().getGroup_3(), "rule__FuncCall__Group_3__0");
					put(grammarAccess.getFuncCallAccess().getGroup_3_1(), "rule__FuncCall__Group_3_1__0");
					put(grammarAccess.getFuncTypedDeclarationAccess().getGroup(), "rule__FuncTypedDeclaration__Group__0");
					...
					put(grammarAccess.getStdFunctionAccess().getGroup(), "rule__StdFunction__Group__0");
					put(grammarAccess.getStdFunctionAccess().getGroup_3(), "rule__StdFunction__Group_3__0");
					put(grammarAccess.getStdFunctionAccess().getGroup_3_1(), "rule__StdFunction__Group_3_1__0");
					put(grammarAccess.getIfExpressionAccess().getGroup(), "rule__IfExpression__Group__0");
					put(grammarAccess.getIfExpressionAccess().getGroup_7(), "rule__IfExpression__Group_7__0");
					put(grammarAccess.getDoWhileExpressionAccess().getGroup(), "rule__DoWhileExpression__Group__0");
					put(grammarAccess.getBrkStrAccess().getGroup(), "rule__BrkStr__Group__0");
					...
					put(grammarAccess.getDSLProgramAccess().getGlobalAssignment_0(), "rule__DSLProgram__GlobalAssignment_0");
					put(grammarAccess.getDSLProgramAccess().getFuncAssignment_1(), "rule__DSLProgram__FuncAssignment_1");
					put(grammarAccess.getDSLProgramAccess().getMainAssignment_2(), "rule__DSLProgram__MainAssignment_2");
					put(grammarAccess.getMainDeclaredAccess().getBodyAssignment_5(), "rule__MainDeclared__BodyAssignment_5");
					put(grammarAccess.getVarReturnAccess().getRtnAssignment_1(), "rule__VarReturn__RtnAssignment_1");
					put(grammarAccess.getVarDeclaredAccess().getScopeAssignment_1(), "rule__VarDeclared__ScopeAssignment_1");
					put(grammarAccess.getVarDeclaredAccess().getNameAssignment_2_0(), "rule__VarDeclared__NameAssignment_2_0");
					put(grammarAccess.getVarDeclaredAccess().getNameAssignment_2_1_0(), "rule__VarDeclared__NameAssignment_2_1_0");
					put(grammarAccess.getVarDeclaredAccess().getDimAssignment_2_1_1(), "rule__VarDeclared__DimAssignment_2_1_1");
					put(grammarAccess.getVarDeclaredAccess().getTypeAssignment_4(), "rule__VarDeclared__TypeAssignment_4");
					put(grammarAccess.getVarAssignmentAccess().getOpAssignment_1_1_0(), "rule__VarAssignment__OpAssignment_1_1_0");
					put(grammarAccess.getVarAssignmentAccess().getRightAssignment_1_1_1(), "rule__VarAssignment__RightAssignment_1_1_1");
					put(grammarAccess.getTerminalAccess().getValueAssignment_0_1(), "rule__Terminal__ValueAssignment_0_1");
					put(grammarAccess.getTerminalAccess().getValueAssignment_1_1(), "rule__Terminal__ValueAssignment_1_1");
					put(grammarAccess.getTerminalAccess().getVarRefAssignment_2_1(), "rule__Terminal__VarRefAssignment_2_1");
					put(grammarAccess.getTerminalAccess().getVarRefAssignment_3_1(), "rule__Terminal__VarRefAssignment_3_1");
					put(grammarAccess.getTerminalAccess().getDimAssignment_3_2(), "rule__Terminal__DimAssignment_3_2");
					put(grammarAccess.getTerminalAccess().getVarRefAssignment_4_1(), "rule__Terminal__VarRefAssignment_4_1");
					put(grammarAccess.getArrayDimensionAccess().getIndexAssignment_2_0(), "rule__ArrayDimension__IndexAssignment_2_0");
					put(grammarAccess.getArrayDimensionAccess().getSizeAssignment_2_1(), "rule__ArrayDimension__SizeAssignment_2_1");
					put(grammarAccess.getFuncCallAccess().getFuncAssignment_1(), "rule__FuncCall__FuncAssignment_1");
					put(grammarAccess.getFuncCallAccess().getArgsAssignment_3_0(), "rule__FuncCall__ArgsAssignment_3_0");
					put(grammarAccess.getFuncCallAccess().getArgsAssignment_3_1_1(), "rule__FuncCall__ArgsAssignment_3_1_1");
					put(grammarAccess.getFuncTypedDeclarationAccess().getTypeAssignment_0(), "rule__FuncTypedDeclaration__TypeAssignment_0");
					put(grammarAccess.getFuncTypedDeclarationAccess().getNameAssignment_1(), "rule__FuncTypedDeclaration__NameAssignment_1");
					put(grammarAccess.getFuncDefinitionAccess().getNameAssignment_1(), "rule__FuncDefinition__NameAssignment_1");
					put(grammarAccess.getFuncDefinitionAccess().getArgsAssignment_3_0(), "rule__FuncDefinition__ArgsAssignment_3_0");
					put(grammarAccess.getFuncDefinitionAccess().getArgsAssignment_3_1_1(), "rule__FuncDefinition__ArgsAssignment_3_1_1");
					put(grammarAccess.getFuncDefinitionAccess().getBodyAssignment_6(), "rule__FuncDefinition__BodyAssignment_6");
					put(grammarAccess.getStdFunctionAccess().getNameAssignment_1(), "rule__StdFunction__NameAssignment_1");
					put(grammarAccess.getStdFunctionAccess().getArgsAssignment_3_0(), "rule__StdFunction__ArgsAssignment_3_0");
					put(grammarAccess.getStdFunctionAccess().getArgsAssignment_3_1_1(), "rule__StdFunction__ArgsAssignment_3_1_1");
					put(grammarAccess.getIfExpressionAccess().getIfconditonAssignment_3(), "rule__IfExpression__IfconditonAssignment_3");
					put(grammarAccess.getIfExpressionAccess().getThenAssignment_6(), "rule__IfExpression__ThenAssignment_6");
					put(grammarAccess.getIfExpressionAccess().getElseAssignment_7_3(), "rule__IfExpression__ElseAssignment_7_3");
					put(grammarAccess.getDoWhileExpressionAccess().getLoopConditonAssignment_3(), "rule__DoWhileExpression__LoopConditonAssignment_3");
					put(grammarAccess.getDoWhileExpressionAccess().getBodyAssignment_6(), "rule__DoWhileExpression__BodyAssignment_6");
					put(grammarAccess.getBrkStrAccess().getBrkAssignment_1(), "rule__BrkStr__BrkAssignment_1");
