...
public class MydslSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_IfExpression___RightCurlyBracketKeyword_7_0_ElseKeyword_7_1_LeftCurlyBracketKeyword_7_2__q;
	...
	protected void init(IGrammarAccess access) {
		...
		match_IfExpression___RightCurlyBracketKeyword_7_0_ElseKeyword_7_1_LeftCurlyBracketKeyword_7_2__q = new GroupAlias(false, true, new TokenAlias(false, false, grammarAccess.getIfExpressionAccess().getRightCurlyBracketKeyword_7_0()), new TokenAlias(false, false, grammarAccess.getIfExpressionAccess().getElseKeyword_7_1()), new TokenAlias(false, false, grammarAccess.getIfExpressionAccess().getLeftCurlyBracketKeyword_7_2()));
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if (match_IfExpression___RightCurlyBracketKeyword_7_0_ElseKeyword_7_1_LeftCurlyBracketKeyword_7_2__q.equals(syntax))
				emit_IfExpression___RightCurlyBracketKeyword_7_0_ElseKeyword_7_1_LeftCurlyBracketKeyword_7_2__q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     ifconditon=varExpression ')' '{' (ambiguity) '}' (rule end)
	 *     then+=BodyStatement (ambiguity) '}' (rule end)
	 */
	protected void emit_IfExpression___RightCurlyBracketKeyword_7_0_ElseKeyword_7_1_LeftCurlyBracketKeyword_7_2__q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
